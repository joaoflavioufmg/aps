...
call glpsol -m aps.mod -d Div_CLU.dat -d Div_CLU_distdur.dat --cuts --scale --adv --check --wmps aps.mps --nomip
...
call glpsol -m aps.mod -d Div_CLU.dat -d Div_CLU_distdur.dat -r aps.sol
