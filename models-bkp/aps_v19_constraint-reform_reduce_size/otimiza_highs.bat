...
call glpsol -m aps.mod -d BH_CLU.dat -d BH_CLU_distdur.dat --cuts --scale --adv --check --wmps aps.mps --nomip
...
call glpsol -m aps.mod -d BH_CLU.dat -d BH_CLU_distdur.dat -r aps.sol
