...
call glpsol -m aps.mod -d LS_CLU.dat -d LS_CLU_distdur.dat --cuts --scale --adv --check --wmps aps.mps --nomip
...
call glpsol -m aps.mod -d LS_CLU.dat -d LS_CLU_distdur.dat -r aps.sol
